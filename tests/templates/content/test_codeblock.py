...
class TestCodeBlockVariants:
    ...
    def test_editor_variant_title_bar(self, component_builder, theme_name):
        ...
        tsx = component_builder.build_component(
            'CodeBlock',
            {'code': 'test', 'variant': 'editor', 'title': 'app.js'},
            theme_name
        )

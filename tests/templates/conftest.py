...
def assert_valid_typescript(tsx: str):
    ...
    assert tsx.count('<AbsoluteFill') == tsx.count('</AbsoluteFill>'), "Unbalanced AbsoluteFill tags"
...
def assert_has_interface(tsx: str, component_name: str):
    ...
    assert f'React.FC<{component_name}Props>' in tsx, f"Missing React.FC type"
